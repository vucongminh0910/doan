	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<?php 
					$id = $_GET['catid'];
					$get_cat = mysqli_query($mysqli,"SELECT * FROM tbl_category WHERE catId = '$id'");
					$row_name_cat = mysqli_fetch_array($get_cat);
					echo '<span>'.$row_name_cat['catName'].'</span>';
				 ?>
				</h3>
			<!-- //tittle heading -->
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-12">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<?php 
									$get_pro_best = mysqli_query($mysqli,"SELECT * FROM tbl_product WHERE catId = '$id'");
